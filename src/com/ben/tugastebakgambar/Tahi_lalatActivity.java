...
public class Tahi_lalatActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tahi_lalat);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tahi_lalat, menu);
		return true;
	}
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Rekening_gendutActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
