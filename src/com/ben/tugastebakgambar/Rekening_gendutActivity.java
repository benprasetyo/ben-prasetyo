package com.ben.tugastebakgambar;
...
public class Rekening_gendutActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_rekening_gendut);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.rekening_gendut, menu);
		return true;
	}
	
	 public void cekJawaban(View v){
	    	String jawabanBenar = "REKENING GENDUT";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Sedot_upilActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
