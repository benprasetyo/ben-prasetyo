...
public class Datang_bulanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_datang_bulan);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.datang_bulan, menu);
		return true;
	}

	 public void cekJawaban(View v){
	    	String jawabanBenar = "DATANG BULAN";
