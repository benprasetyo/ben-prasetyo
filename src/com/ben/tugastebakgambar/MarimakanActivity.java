...
public class MarimakanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_marimakan);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.marimakan, menu);
		return true;
	}
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Tahi_lalatActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
