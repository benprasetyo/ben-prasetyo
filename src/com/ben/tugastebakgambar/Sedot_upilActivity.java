...
public class Sedot_upilActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sedot_upil);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sedot_upil, menu);
		return true;
	}
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Pil_cinaActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
