...
public class Keong_racunActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_keong_racun);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.keong_racun, menu);
		return true;
	}
	...
	public void cekJawaban(View v){
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),Datang_bulanActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
