...
public class CuacaActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cuaca, menu);
		return true;
	}
	
	 public void cekJawaban(View v){
	    	String jawabanBenar = "CUACA";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Iga_bakarActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
