...
public class Iga_bakarActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_iga_bakar);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.iga_bakar, menu);
		return true;
	}
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Keong_racunActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
