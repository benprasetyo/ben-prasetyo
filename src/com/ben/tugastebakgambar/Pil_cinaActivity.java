...
public class Pil_cinaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pil_cina);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pil_cina, menu);
		return true;
	}
	
	 public void cekJawaban(View v){
	    	String jawabanBenar = "PIL CINA";
